...
class OpponentDatabase:
    def __init__(self, db_path: str = "data/opponents.db"):
    ...
    def save_profile(self, profile: OpponentProfile):
    ...
    def update_profile(self, name: str, actions, went_to_showdown=False, showdown_hand=None):
